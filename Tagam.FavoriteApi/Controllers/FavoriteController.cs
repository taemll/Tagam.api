...
namespace Tagam.FavoriteApi.Controllers
{
    ...
    public class FavoriteController : Controller
    {
        ...
        {
            var favorite = _favoriteRepository.Create(favoriteDto);
        ...
        {
            var favorite = _favoriteRepository.Remove(id);
            return new ApiResponse(HttpStatusCode.OK, favorite);
        }
        ...
        {
            var favorite = _favoriteRepository.GetFavoritesByClientId(id);
            return new ApiResponse(HttpStatusCode.OK, favorite);
        }
        ...
        {
            var favorite = _favoriteRepository.GetFavoritesByRecipeId(id);
            return new ApiResponse(HttpStatusCode.OK, favorite);
        }
    }
}
